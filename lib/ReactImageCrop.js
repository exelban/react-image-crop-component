...
var ReactImageCrop = React.createClass({
    ...
    render() {
        return <div style={this.state.style1} ref="react_image_crop_component"
    ...
    mouseMove(e) {
        ...
        if(this.state.active){
            ...
            let crop = this.refs.crop;
            let block = this.refs.react_image_crop_component;
            let l = -1*(this.state.startX - posX + this.state.blockX);
            let t = -1*(this.state.startY - posY + this.state.blockY);
