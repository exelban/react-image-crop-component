...
var ReactImageCrop = React.createClass({
    ...
    render() {
        return <div style={this.state.styles.block} ref="react_image_crop_component"
            ...
            <div style={this.state.styles.crop} ref="crop">
                {this.props.resize ? <div style={{position: "absolute"}} ref="previewDIV">
                    <div style={this.state.styles.resizeP1} ref="resizeP1"/>
                    <div style={this.state.styles.resizeP2} ref="resizeP2"/>
                    <div style={this.state.styles.resizeP3} ref="resizeP3"/>
                    <div style={this.state.styles.resizeP4} ref="resizeP4"/>
                    <div style={this.state.styles.resizeP5} ref="resizeP5"/>
                    <div style={this.state.styles.resizeP6} ref="resizeP6"/>
                    <div style={this.state.styles.resizeP7} ref="resizeP7"/>
                    <div style={this.state.styles.resizeP8} ref="resizeP8"/>
                </div> : null}
                <div style={this.state.styles.preview}><img src={this.state.src} ref="preview"/></div>
            </div>
            <div style={this.state.styles.bg}/>
            <img style={this.state.styles.img} ref="img" src={this.state.src}/>
        </div>;
    },
    mouseDown(e) {
        e.preventDefault();
