...
const ReactCropComponent = React.createClass({
    ...
    render() {
        return <div ref="react_image_crop_component" className="react-image-crop-component" onMouseLeave={this.mouseLeave} onMouseDown={this.mouseDown} onMouseMove={this.mouseMove} onMouseUp={this.mouseUp}>
